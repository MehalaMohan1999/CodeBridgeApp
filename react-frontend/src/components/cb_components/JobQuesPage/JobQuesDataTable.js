...
const JobQuesDataTable = ({
  ...
  const p_dateTemplate5 = (rowData, { rowIndex }) => (
    ...
    <>
      ...
      >
        ...
        <Column
          ...
          header="From Service"
          body={pTemplate2}
          filter={selectedFilterFields.includes("fromService")}
          hidden={selectedHideFields?.includes("fromService")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          ...
          header="To Service"
          body={pTemplate3}
          filter={selectedFilterFields.includes("toService")}
          hidden={selectedHideFields?.includes("toService")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          ...
          filter={selectedFilterFields.includes("start")}
          hidden={selectedHideFields?.includes("start")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
        ...
        <Column
          field="dynaLoaderId"
          header="DynaLoader Id"
          body={dropdownTemplate8}
          filter={selectedFilterFields.includes("dynaLoaderId")}
          hidden={selectedHideFields?.includes("dynaLoaderId")}
          style={{ minWidth: "8rem" }}
        />
        <Column
          field="email"
