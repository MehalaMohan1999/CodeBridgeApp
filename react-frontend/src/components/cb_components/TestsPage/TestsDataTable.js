...
const TestsDataTable = ({
  ...
  const badgeTemplate2 = (rowData, { rowIndex }) => (
    <Badge value={Number(rowData.passed)} />
  );
  const badgeTemplate3 = (rowData, { rowIndex }) => (
    <Badge value={Number(rowData.failed)} />
  );
    ...
    <>
      ...
      >
        ...
        <Column
          ...
          header="Passed"
          body={badgeTemplate2}
          filter={selectedFilterFields.includes("passed")}
          hidden={selectedHideFields?.includes("passed")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          ...
          header="Failed"
          body={badgeTemplate3}
          filter={selectedFilterFields.includes("failed")}
          hidden={selectedHideFields?.includes("failed")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
