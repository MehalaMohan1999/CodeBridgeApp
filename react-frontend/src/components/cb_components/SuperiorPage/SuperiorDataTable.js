    ...
    <>
      ...
      >
        <Column
          ...
          filter={selectedFilterFields.includes("superior")}
          hidden={selectedHideFields?.includes("superior")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          ...
          header="Subordinate"
          body={pTemplate1}
          filter={selectedFilterFields.includes("subordinate")}
          hidden={selectedHideFields?.includes("subordinate")}
          sortable
          style={{ minWidth: "8rem" }}
        />
      ...
      <Dialog
        header="Upload Superior Data"
        visible={showUpload}
        onHide={() => setShowUpload(false)}
      >
        <UploadService
          user={user}
          serviceName="superior"
          onUploadComplete={() => {
