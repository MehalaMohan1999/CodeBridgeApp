...
const DynaFieldsPage = (props) => {
  ...
  useEffect(() => {
    ...
    setSelectedHideFields(
      service?.schemaList?.map((f, i) =>
        i > 5 && typeof f !== "array" ? f.fieldName : null,
      ),
    );
  }, []);
  ...
  return (
    <div className="mt-5">
      ...
      />
      <DynaFieldsCreateDialogComponent
        service={props.service}
        entity={newRecord}
