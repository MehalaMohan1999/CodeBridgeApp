  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "55vw" }}
        role="mailQues-create-dialog-component"
      >
        ...
        <div className="col-12 md:col-6 field mt-5">
          <span className="align-items-center">
            ...
            <Calendar
              id="end"
              value={_entity?.end ? new Date(_entity?.end) : new Date()}
              dateFormat="dd/mm/yy"
              onChange={(e) => setValByKey("end", new Date(e.target.value))}
              showIcon
              showButtonBar
            />
          </span>
