      ...
      <div role="prompts-create-dialog-component">
        <div>
          ...
          <InputText
            ...
            value={_entity?.sessionid}
            onChange={(e) => setValByKey("sessionid", e.target.value)}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <Dropdown
            value={_entity?.refDocs}
            optionLabel="name"
            optionValue="value"
            options={refDocsOptions}
            onChange={(e) => setValByKey("refDocs", e.value)}
          />
        </div>
        <div>
          ...
          <InputText
            className="w-full mb-3"
            value={_entity?.responseText}
            onChange={(e) => setValByKey("responseText", e.target.value)}
          />
        </div>
        <div>
          ...
          <InputText
            className="w-full mb-3"
            value={_entity?.systemId}
            onChange={(e) => setValByKey("systemId", e.target.value)}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <InputText
            className="w-full mb-3"
            value={_entity?.stopReason}
            onChange={(e) => setValByKey("stopReason", e.target.value)}
          />
        </div>
        <div>
          ...
          <InputText
            className="w-full mb-3"
            value={_entity?.stopSequence}
            onChange={(e) => setValByKey("stopSequence", e.target.value)}
          />
        </div>
        <div>
          ...
          <InputText
            ...
            onChange={(e) => setValByKey("inputTokens", e.target.value)}
          />
        </div>
        <div>
          ...
          <InputText
            ...
            onChange={(e) => setValByKey("outputTokens", e.target.value)}
          />
        </div>
        <div>
          ...
          <InputText
            ...
            className="w-full mb-3"
            value={_entity?.cost}
            onChange={(e) => setValByKey("cost", e.target.value)}
          />
        </div>
        <div>
        ...
        <div>
          ...
          <InputText
            className="w-full mb-3"
            value={_entity?.error}
            onChange={(e) => setValByKey("error", e.target.value)}
          />
        </div>
