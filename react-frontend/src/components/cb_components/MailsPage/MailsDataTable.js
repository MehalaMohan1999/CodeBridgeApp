    ...
    <>
      ...
      >
        <Column
          ...
          filter={selectedFilterFields.includes("sentDateTime")}
          hidden={selectedHideFields?.includes("sentDateTime")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          ...
          filter={selectedFilterFields.includes("sentStatus")}
          hidden={selectedHideFields?.includes("sentStatus")}
          style={{ minWidth: "8rem" }}
        />
        <Column
          field="mailType"
          header="Mail Type"
          body={pTemplate2}
          filter={selectedFilterFields.includes("mailType")}
          hidden={selectedHideFields?.includes("mailType")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          ...
          header="To History"
          body={pTemplate3}
          filter={selectedFilterFields.includes("toHistory")}
          hidden={selectedHideFields?.includes("toHistory")}
          style={{ minWidth: "8rem" }}
        />
